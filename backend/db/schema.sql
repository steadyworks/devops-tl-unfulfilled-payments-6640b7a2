...
--
-- Name: uq_giftcards_idempotency; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_giftcards_idempotency ON public.giftcards USING btree (idempotency_key) WHERE (idempotency_key IS NOT NULL);


--
-- Name: uq_giftcards_provider_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_giftcards_provider_id ON public.giftcards USING btree (provider, provider_giftcard_id) WHERE (provider_giftcard_id IS NOT NULL);
